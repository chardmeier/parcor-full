<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
                ...
                xmlns:smtsentence="www.eml.org/NameSpaces/smtsentence">
...
<xsl:template match="smtsentence:markable" mode="opening">
</xsl:template>

<xsl:template match="smtsentence:markable" mode="closing">
<xsl:text>
</xsl:text>
</xsl:template>
